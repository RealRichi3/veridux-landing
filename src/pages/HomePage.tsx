            ...
            <div className="bg-tertiary">
                ...
                >
                    ...
                    <div className="mb-10 flex justify-center gap-10">
                        ...
                        <a href="">
                            <img src="/apple-store.png" alt="IOS store image" />
                        </a>
                    </div>
                    <img src="/app-intro-image.png" alt="app-image" />
                </section>
            </div>
            ...
            >
                <div className="mx-auto max-w-[1600px]">
                    ...
                    <div className="flex flex-row md:flex-row md:justify-center">
                        <img
                            src="/sponsorship-S.png"
                            alt="logo"
                            className="w-[70px] md:h-[94px] md:w-[180px]"
                        />
                        <img
                            src="/sponsorship-team-apt.png"
                            alt="team-apt-logo"
                            className="w-[70px] md:h-[94px] md:w-[180px]"
                        />
                        <img
                            src="/sponsorship-alpha.png"
                            alt="alpha-logo"
                            className="w-[70px] md:h-[94px] md:w-[180px]"
                        />
                        <img
                            src="/sponsorship-busha.png"
                            alt="busha-logo"
                            className="w-[70px] md:h-[94px] md:w-[180px]"
                        />
                    </div>
                ...
                >
                    ...
                    <div className="mt-10 grid grid-cols-1 items-center gap-10 bg-white lg:grid-cols-2">
                        <div className="flex items-center justify-center rounded-xl bg-[#DDEBF8]">
                            <img src="/top-up.png" alt="top-up-image" />
                        </div>
                        <div>
